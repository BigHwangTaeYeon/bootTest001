package test1.hwang.controller;
...
import test1.hwang.dto.MemberDTO;

@RestController
@RequestMapping("/api/v1/get-api")
public class PutController {
    //localhost:8081/api/v1/get-api/member
    ...
    public String postMember(@RequestBody Map<String, Object> putData){
        ...
        //Param.forEach((key, Value) -> sb.append(key).append(" : ").append(value).appen("\n"));
        return sb.toString();
    }
